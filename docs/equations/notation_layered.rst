...
.. math::
   ...
   {q_{\mathrm{N}}} &= {\nabla^2}\psi_{\mathrm{N}}+ \frac{f_0^2}{H_{\mathrm{N}}} \left(\frac{\psi_{\mathrm{N}-1}-\psi_{\mathrm{N}}}{g'_{{\mathrm{N}}-1}}\right) \,,
   \end{aligned}
...
:math:`\delta_{n,\mathrm{N}}`, indicates that the drag is only applied in the
